...
print "\n opening file information_task2.csv \n"
counter=1

for line in open('RandomSampleOutputforTask2.csv','r'):
        f  = open('reviewsinfo_top10.csv','w')
        f2 = open('reviewsinfo_top20.csv','w')
        f3 = open('reviewsinfo_top30.csv','w')	
	data =line.split(",")
	scores=dict()
	#print line
	count=dict();
