...
public class Default_LR {
    
	public static void main(String[] args) throws Exception {
		
		//Input Output Filenames for Logistic Regression
		File fin = new File("Dataset2_adjectives.arff");
        File fout = new File("Dataset2_LogisticReg-Adj.txt");
